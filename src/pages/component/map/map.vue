  ...
  <view class="content">
    ...
    <uni-list class="scrollview">
      ...
      <uni-list-item
        :show-arrow="false"
        :show-switch="true"
        :switch-checked="enableSatellite"
        title="是否开启卫星图"
