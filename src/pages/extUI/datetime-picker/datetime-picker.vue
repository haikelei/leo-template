  ...
  <view class="page container">
    ...
    <view class="example-body">
      <uni-datetime-picker
        type="datetime"
        returnType="date"
        v-model="dateInstance"
        @change="change"
      />
    </view>
    <uni-section :title="'插槽用法：' + dateString" type="line"></uni-section>
    <view class="example-body">
      <uni-datetime-picker v-model="dateString"
...
export default {
  data() {
    return {
      ...
      dateRange: [
        this.getDate(Date.now() - 5 * 24 * 3600000),
        this.getDate(Date.now() + 5 * 24 * 3600000)
      ],
      datetimeRange: [
        this.getDateTime(Date.now() - 5 * 24 * 3600000),
        this.getDateTime(Date.now() + 5 * 24 * 3600000)
      ],
